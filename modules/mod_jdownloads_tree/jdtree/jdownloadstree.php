...
* -----------------------------------------------------------------------------------------------------
* Modified for jDownloads 3.8 by Arno Betz
* Added feature to only show Overview if Category list is empty  CAM 2016-06-09 circa line 301
*/
// no direct access
...
class jdownloadstree{
    ...
    */
	...
	function drawSubNode($parentID, $params){
		$catid = intval(ArrayHelper::getValue($_REQUEST, 'catid', 0));
        if(isset($this->elementArray[$parentID])){			
            ...
            for ($no=0; $no < count($this->elementArray[$parentID]) ;$no++){
				...
				if ($this->elementArray[$parentID][$no][0] != $catid){
                    ...
                    echo "<li class=\"j7dctree_node\"><img height=\"18\" width= \"18\" \"alt=\"plusminus-".$parentID.$no."\" class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no][0]."\" src=\"modules/mod_jdownloads_tree/jdtree/images/plus.gif\"><img height=\"16\" width= \"16\" \"alt=\"folder-".$parentID.$no."\" src=\"".$this->elementArray[$parentID][$no][4]."\"><a class=\"j7dctree_link\"$urlAdd>".$this->elementArray[$parentID][$no][1].$amount_sub_cats.$amount_items."</a>";    
                } else { 
                    echo "<li class=\"j7dctree_node\"><img height=\"18\" \"alt=\"plusminus-".$parentID.$no."\" width= \"18\" class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no][0]."\" src=\"modules/mod_jdownloads_tree/jdtree/images/plus.gif\"><img height=\"16\" width= \"16\" \"alt=\"folder-".$parentID.$no."\" src=\"".$this->elementArray[$parentID][$no][4]."\">".$this->elementArray[$parentID][$no][1].$amount_sub_cats.$amount_items;      
                }  
	...
	function drawTree($home_link, $moduleclass_sfx, $params){
		...
		if ($params->get('catid') == '') { 
			echo '<img height="18" width="18" alt="base" src="modules/mod_jdownloads_tree/jdtree/images/base.gif" />'.$home_link;
		}
        for($no = 0; $no < count($this->elementArray[0]); $no++){
            ...
            if ($this->elementArray[0][$no][0] != $catid){
                ...
                echo "<li onmouseover=\"this.className='jdmroothov'\" onmouseout=\"this.className='j7dctree_node'\" class=\"j7dctree_node\" id=\"node_".$this->elementArray[0][$no][0]."\"><img height=\"18\" width= \"18\" alt=\"plusminus-".$no."\" id=\"plusMinus".$this->elementArray[0][$no][0]."\" class=\"tree_plusminus\" src=\"modules/mod_jdownloads_tree/jdtree/images/plus.gif\"><img height=\"16\" width= \"16\" alt=\"folder-".$no."\" src=\"".$this->elementArray[0][$no][4]."\"><a class=\"j7dctree_link\"$urlAdd>".$this->elementArray[0][$no][1].$amount_sub_cats.$amount_items."</a>";
				
            } else {
                echo "<li onmouseover=\"this.className='jdmroothov'\" onmouseout=\"this.className='j7dctree_node'\" class=\"j7dctree_node\" id=\"node_".$this->elementArray[0][$no][0]."\"><img height=\"18\" width= \"18\" alt=\"plusminus-".$no."\" id=\"plusMinus".$this->elementArray[0][$no][0]."\" class=\"tree_plusminus\" src=\"modules/mod_jdownloads_tree/jdtree/images/plus.gif\"><img height=\"16\" width= \"16\" alt=\"folder-".$no."\" src=\"".$this->elementArray[0][$no][4]."\">".$this->elementArray[0][$no][1].$amount_sub_cats.$amount_items;        
            }     
