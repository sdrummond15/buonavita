...
* It is only for jDownloads 3.9 and 3.10 (Support: www.jDownloads.com)
*/
...
defined( '_JEXEC' ) or die( 'Restricted access' );
    ...
    $hits 		           = trim($params->get( 'hits_label' ));
	$hits_label       	   = modJdownloadsRelatedHelper::getOnlyLanguageSubstring($hits);
    ...
    $cat_text  		       = trim($params->get( 'cat_show_text' ));
    $cat_show_text         = modJdownloadsRelatedHelper::getOnlyLanguageSubstring($cat_text);
