<?php
/**
* @version $Id: mod_jdownloads_featured.php v3.8
...
/** This Modul shows the newest added 'featured' downloads from the component jDownloads. 
*/
...
defined( '_JEXEC' ) or die( 'Restricted access' );
    ...
    $text_before           = ModJDownloadsFeaturedHelper::getOnlyLanguageSubstring($before);
    $after                 = trim($params->get( 'text_after' ) );
    $text_after            = ModJDownloadsFeaturedHelper::getOnlyLanguageSubstring($after);
    ...
    $cat_show_text         = ModJDownloadsFeaturedHelper::getOnlyLanguageSubstring($cat_show_text);
    ...
    $files = ModJDownloadsFeaturedHelper::getList($params);
    ...
    require JModuleHelper::getLayoutPath('mod_jdownloads_featured',$params->get('layout', 'default'));
?>