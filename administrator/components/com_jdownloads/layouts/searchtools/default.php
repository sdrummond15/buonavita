...
<div class="js-stools clearfix">
	<div class="clearfix">
		...
		<div class="js-stools-container-selector">
			<?php echo JLayoutHelper::render('searchtools.default.selector', $data, $basePath); ?>
		</div>
		<?php endif; ?>
		<div class="js-stools-container-bar">
			<?php echo JLayoutHelper::render('searchtools.default.bar', $data, $basePath); ?>
		</div>
		<div class="js-stools-container-list hidden-phone hidden-tablet">
			<?php echo JLayoutHelper::render('searchtools.default.list', $data, $basePath); ?>
		</div>
	</div>
	<!-- Filters div -->
	<?php if ($data['options']['filterButton']) : ?>
	<div class="js-stools-container-filters hidden-phone clearfix<?php echo $filtersActiveClass; ?>">
		<?php echo JLayoutHelper::render('searchtools.default.filters', $data, $basePath); ?>
	</div>
	<?php endif; ?>
</div>
<?php if ($data['options']['showNoResults']) : ?>
	<?php echo JLayoutHelper::render('searchtools.default.noitems', $data, $basePath); ?>
<?php endif; ?>
