 ...
 * @since  3.7.0
 */
class JDownloadsControllerAssociation extends JControllerForm
{
	/**
	...
	public function edit($key = null, $urlVar = null)
	{
		...
		if (!JDAssociationsHelper::allowEdit($extensionName, $typeName, $id))
		{
			JFactory::getApplication()->enqueueMessage(JText::_('JLIB_APPLICATION_ERROR_EDIT_NOT_PERMITTED'), 'error');
			$this->setRedirect(JRoute::_('index.php?option=com_jdownloads&view=associations', false));
	...
	public function cancel($key = null)
	{
		...
		if (JDAssociationsHelper::typeSupportsCheckout($extensionName, $typeName))
		{
			$ids      = array();
			...
			{
				JDAssociationsHelper::getItem($extensionName, $typeName, $id)->checkin();
			}
		}
