 ...
 * @since  3.7.0
 */
class JDownloadsControllerAssociations extends JControllerAdmin
{
	/**
	 ...
	 * @since   3.7.0
	 */
	public function getModel($name = 'associations', $prefix = 'JDownloadsModel', $config = array('ignore_request' => true))
	{
	...
	public function checkin()
	{
		...
		if (JDAssociationsHelper::typeSupportsCheckout($extensionName, $typeName) === false)
		{
		...
		if (JDAssociationsHelper::canCheckinItem($extensionName, $typeName, $id) === true)
		{
			$item = JDAssociationsHelper::getItem($extensionName, $typeName, $id);
