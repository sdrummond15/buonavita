...
class jdownloadsControllerbackup extends jdownloadsController
{
    ...
    public function runbackup()
    {
        ...
        if (JFactory::getUser()->authorise('com_jdownloads.core.admin','com_jdownloads'))
        {  
            
            $website_title = JFactory::getApplication()->get('sitename', 'noname');
            $from_url      = JUri::getInstance();
