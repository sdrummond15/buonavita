...
?>
<form action="<?php echo JRoute::_('index.php?option=com_jdownloads&view=associations&layout=modal&tmpl=component&function='
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="nowrap has-context">
						...
						<?php elseif ($canEdit && $isCheckout) : ?>
							...
							<span title="<?php echo JText::sprintf('COM_JDOWNLOADS_ALIAS', $this->escape($item->alias)); ?>">
						...
						<?php if (!empty($this->typeFields['catid'])) : ?>
							<div class="small">
								<?php echo JText::_('COM_JDOWNLOADS_CATEGORY') . ": " . $this->escape($item->category_title); ?>
							</div>
						<?php endif; ?>
					</td>
					<td class="small">
					...
					<td>
						<?php if (true || $item->association) : ?>
							<?php echo JDAssociationsHelper::getAssociationHtmlList($this->extensionName, $this->typeName, (int) $item->id, $item->language, false, false); ?>
						<?php endif; ?>
					</td>
					<?php if (!empty($this->typeFields['menutype'])) : ?>
						<td class="small">
