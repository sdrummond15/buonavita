...
<button id="toogle-left-panel" class="btn btn-small"
		data-show-reference="<?php echo JText::_('COM_JDOWNLOADS_ASSOCIATIONS_EDIT_SHOW_REFERENCE'); ?>"
		data-hide-reference="<?php echo JText::_('COM_JDOWNLOADS_ASSOCIATIONS_EDIT_HIDE_REFERENCE'); ?>"><?php echo JText::_('COM_JDOWNLOADS_ASSOCIATIONS_EDIT_HIDE_REFERENCE'); ?>
</button>

<form action="<?php echo JRoute::_('index.php?option=com_jdownloads&view=association&' . http_build_query($options)); ?>" method="post" name="adminForm" id="adminForm" data-associatedview="<?php echo $this->typeName; ?>">
	<div class="sidebyside">
		<div class="outer-panel" id="left-panel">
			<div class="inner-panel">
				<h3><?php echo JText::_('COM_JDOWNLOADS_ASSOCIATIONS_REFERENCE_ITEM'); ?></h3>
		...
		<div class="outer-panel" id="right-panel">
			<div class="inner-panel">
				<div class="language-selector">
					<h3 class="target-text"><?php echo JText::_('COM_JDOWNLOADS_ASSOCIATIONS_ASSOCIATED_ITEM'); ?></h3>
