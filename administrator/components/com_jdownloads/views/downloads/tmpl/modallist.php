...
$document->addScript(JURI::base().'administrator/components/com_jdownloads/assets/js/admin-downloads-modal.js');
...
<form action="<?php echo JRoute::_('index.php?option=com_jdownloads&view=downloads&layout=modallist&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm" class="form-inline">
