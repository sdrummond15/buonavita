...
<div class="container-fluid">
    ...
    <div class="alert alert-info">
        <ul>
            <?php echo JText::_('COM_JDOWNLOADS_BATCH_DOWNLOAD_NOTE'); ?>
    ...
    <div class="row-fluid">
        <?php if ($published >= 0) : ?>
            <div class="control-group span6">
                <div class="controls">
                  ...
                  <?php echo JLayoutHelper::render('html.batch.downloads', $this->categories, $basePath); ?>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="control-group span6">
            <div class="controls">
              <?php // display price field ?>
              <?php echo JLayoutHelper::render('html.batch.price'); ?>
            </div>
        </div>
