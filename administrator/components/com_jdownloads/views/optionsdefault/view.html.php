 ...
 *
 */
class jdownloadsViewOptionsDefault extends JViewLegacy
{
    protected $canDo;
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_JDOWNLOADS').': '.JText::_('COM_JDOWNLOADS_OPTIONS_DEFAULT'), 'cogs jdrestore');
        
        JToolBarHelper::link('index.php?option=com_jdownloads', JText::_('COM_JDOWNLOADS_CPANEL'), 'home-2 cpanel');
        JToolBarHelper::back();
        
        if ($canDo->get('core.admin')) {
            JToolBarHelper::custom( 'optionsdefault.rundefault', 'new', 'new', JText::_('COM_JDOWNLOADS_OPTIONS_DEFAULT'), false, false ); 
