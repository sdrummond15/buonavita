...
class JFormFieldModalAssociation extends JFormField
{
	...
	protected function getInput()
	{
		...
		$linkAssociations = 'index.php?option=com_jdownloads&amp;view=associations&amp;layout=modal&amp;tmpl=component'
		...
		$html[] = '<button'
			...
			. ' data-toggle="modal"'
			. ' data-select="' . JText::_('COM_JDOWNLOADS_ASSOCIATIONS_SELECT_TARGET') . '"'
			. ' data-change="' . JText::_('COM_JDOWNLOADS_ASSOCIATIONS_CHANGE_TARGET') . '"'
		...
		$html[] = JHtml::_(
			...
			array(
				'title'       => JText::_('COM_JDOWNLOADS_ASSOCIATIONS_SELECT_TARGET'),
				'backdrop'    => 'static',
				'url'         => $urlSelect,
				'height'      => '400px',
				'width'       => '800px',
