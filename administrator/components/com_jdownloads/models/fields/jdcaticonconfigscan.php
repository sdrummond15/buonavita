 ...
 * @since 1.6
 */
class JFormFieldjdcaticonconfigscan extends JFormFieldFileList
{
     /**
     * The form field type.
     *
     ...
     protected function getInput()
     {
        ...
        $pic_list .= '<script language="javascript" type="text/javascript">'."
            if (document.adminForm.jform_autopublish_cat_pic_default_filename.options.value != '-1'){
                jsimg=\"".JURI::root().'images/jdownloads/catimages/'."\" + getSelectedText( 'adminForm', 'jform_autopublish_cat_pic_default_filename' );
            } else {
                jsimg='';
            }
