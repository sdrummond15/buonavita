...
class jdownloadsModelList extends JModelList
{
    ...
    protected function getListQuery()
    {
        ...
        $query->select(
            $this->getState(
                'list.select',
                'DISTINCT a.id, a.title, a.alias, a.description, a.file_pic, a.price, a.release, a.catid, '.
                'a.size, a.created, a.created_by, a.modified, a.modified_by, a.publish_up, a.publish_down, a.url_download, a.other_file_id, a.extern_file, a.downloads, '.
        ...
        $query->select('u3.username AS single_user_access');
