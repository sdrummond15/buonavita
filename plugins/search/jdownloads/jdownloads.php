         ...
         */    
          ...
          {  
                ...
                if ($limit > 0)
                {
                    ...
                    $query->select('a.title, a.metadesc, a.metakey, a.created, a.language, a.author, a.url_download, a.extern_file, a.password, a.license_agree, a.other_file_id');
                    ...
                    $query->group('a.id, a.title, a.metadesc, a.metakey, a.created, a.description, a.description_long, c.title, a.alias, c.alias, c.id, a.author');                    
                    $query->order($order);
